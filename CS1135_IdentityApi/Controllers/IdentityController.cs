...
namespace CS1135_IdentityApi.Controllers
{
    [ApiController]
    public class IdentityController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            var authSigningKey =
                new SymmetricSecurityKey(Encoding.UTF8.GetBytes(configuration.GetValue<string>("Security:Secret")));

            var token = new JwtSecurityToken(issuer: "http://localhost:10800", audience: "*",
